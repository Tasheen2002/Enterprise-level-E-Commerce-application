...
export class InitializeCheckoutHandler implements ICommandHandler<InitializeCheckoutCommand, CommandResult<CheckoutDto>> {
  constructor(private readonly checkoutService: CheckoutService) {}

  async handle(command: InitializeCheckoutCommand): Promise<CommandResult<CheckoutDto>> {
