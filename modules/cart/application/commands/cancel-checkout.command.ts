...
export class CancelCheckoutHandler implements ICommandHandler<CancelCheckoutCommand, CommandResult<CheckoutDto>> {
  constructor(private readonly checkoutService: CheckoutService) {}

  async handle(command: CancelCheckoutCommand): Promise<CommandResult<CheckoutDto>> {
