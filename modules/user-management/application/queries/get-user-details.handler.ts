...
import { GetUserDetailsQuery, GetUserDetailsResult } from "./get-user-details.query";

export class GetUserDetailsHandler implements IQueryHandler<GetUserDetailsQuery, QueryResult<GetUserDetailsResult>> {
  constructor(
    private readonly userRepository: IUserRepository,
    private readonly addressRepository: IAddressRepository,
  ) {}

  async handle(query: GetUserDetailsQuery): Promise<QueryResult<GetUserDetailsResult>> {
    try {
