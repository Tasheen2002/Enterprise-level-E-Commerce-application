...
import { createRateLimiter, RateLimitPresets } from "../../../../../apps/api/src/shared/middleware/rate-limiter.middleware";
...
export async function registerAuthRoutes(
  ...
  }, (request, reply) => controller.logout(request as any, reply));
  ...
  }, (request, reply) => controller.me(request as any, reply));
  ...
  }, (request, reply) => controller.changePassword(request as any, reply));
  ...
  }, (request, reply) => controller.initiatePasswordReset(request as any, reply));
  ...
  }, (request, reply) => controller.resendVerification(request as any, reply));

  // POST /auth/change-email
  fastify.post("/auth/change-email", {
    preHandler: [authenticate],
    schema: {
      tags: ["Authentication"],
  ...
  }, (request, reply) => controller.changeEmail(request as any, reply));

  // POST /auth/delete-account
  fastify.post("/auth/delete-account", {
    preHandler: [authenticate],
    schema: {
      tags: ["Authentication"],
  ...
  }, (request, reply) => controller.deleteAccount(request as any, reply));
}
